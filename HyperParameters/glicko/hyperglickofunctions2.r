...
getGlickos = function(rdIntNow, cNow) {
  ...
  for (i in 1 : Nall) {
    ...
    if (row_nr_winner > 0 & row_nr_loser > 0) {
      ...
      if (games$Surface[i] == "Hard") {
        glicko$Hard_rdGames[row_nr_winner] <- updateRDBeforeGame(glicko$Hard_rdGames[row_nr_winner], glicko$Hard_last_game[row_nr_winner], gameDate, rdIntNow, cNow)
        glicko$Hard_rdGames[row_nr_loser]  <- updateRDBeforeGame(glicko$Hard_rdGames[row_nr_loser], glicko$Hard_last_game[row_nr_loser], gameDate, rdIntNow, cNow)
        #Update date last game
      ...
      GamesResultWinner  <- calculateFractionGamesWinnerWon(games[i, ])
      ...
      # surface dependent variables
      if (games$Surface[i] == "Hard") {
        glicko$Hard_RatingsGames[row_nr_winner]                   <- calculateNewGlicko(glicko$Hard_RatingsGames[row_nr_winner], glicko$Hard_RatingsGames[row_nr_loser], glicko$Hard_rdGames[row_nr_winner], glicko$Hard_rdGames[row_nr_loser], GamesResultWinner)
        glicko$Hard_RatingsGames[row_nr_loser]                    <- calculateNewGlicko(glicko$Hard_RatingsGames[row_nr_loser], glicko$Hard_RatingsGames[row_nr_winner], glicko$Hard_rdGames[row_nr_loser], glicko$Hard_rdGames[row_nr_winner], GamesResultLoser)
        
        glicko$Hard_rdGames[row_nr_winner] <- calculateRDAfterGame(glicko$Hard_RatingsGames[row_nr_winner], glicko$Hard_RatingsGames[row_nr_loser], glicko$Hard_rdGames[row_nr_winner], glicko$Hard_rdGames[row_nr_loser], GamesResultWinner)
        glicko$Hard_rdGames[row_nr_loser]  <- calculateRDAfterGame(glicko$Hard_RatingsGames[row_nr_loser], glicko$Hard_RatingsGames[row_nr_winner], glicko$Hard_rdGames[row_nr_loser], glicko$Hard_rdGames[row_nr_winner], GamesResultLoser)
