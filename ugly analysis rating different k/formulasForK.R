...
UpdateRating <- function(rating, winner, loser, surface, diffK, Bo5) {
  ...
  #Surface Ratings
  if(surface == "Hard") {
    rating$Hard_Ratings = UpdateThisRatingType(rating$Hard_Ratings, rating$Hard_games, indexWinner, indexLoser, diffK, Bo5)
    rating$Hard_games = AddAGame(rating$Hard_games, indexWinner, indexLoser)
    
  }else if(surface == "Grass") {
    rating$Grass_Ratings = UpdateThisRatingType(rating$Grass_Ratings, rating$Grass_games, indexWinner, indexLoser, diffK, Bo5)
    rating$Grass_games = AddAGame(rating$Grass_games, indexWinner, indexLoser)
    
  } else if(surface == "Clay") {
    rating$Clay_Ratings = UpdateThisRatingType(rating$Clay_Ratings, rating$Clay_games, indexWinner, indexLoser, diffK, Bo5)
    rating$Clay_games = AddAGame(rating$Clay_games, indexWinner, indexLoser)
    
  } else if(surface == "Carpet") {
    rating$Carpet_Ratings = UpdateThisRatingType(rating$Carpet_Ratings, rating$Carpet_games, indexWinner, indexLoser, diffK, Bo5)
...
UpdateThisRatingType <- function(Ratings, games, indexWinner, indexLoser, diffK, Bo5) {
  Kwinner = K(games[indexWinner], diffK, Bo5)
  Kloser = K(games[indexLoser], diffK, Bo5)
...
K <- function(numberOfGames, diffK, Bo5) {
